...
const Hero = () => {
  return (
    <div className="text-[#9b2289]  h-screen max-w-screen flex flex-col items-center font-allura bg-[url(./img1.jpg)] bg-center bg-cover bg-no-repeat relative font-bold">
      <div className="bg-[#f1cfe971] absolute  h-screen w-screen flex flex-col items-center font-allura ">
        ...
        <div className={`flex flex-col items-center text-5xl md:text-8xl`}>
          ...
          <div className="flex gap-4 flex-wrap">
            {/* <Image src={img1} alt="hearts" className=" w-auto rounded-md" /> */}
            <Image
              src={img4}
              alt="hearts"
          ...
          <div className=" pb-4 ">2081/10/25</div>
        </div>
      </div>
    </div>
  );
